...
from utils.database import BaseDatabaseManager, MySQLManager, read_jdbc_table
...
def main(spark: SparkSession, settings: Settings, app_args) -> None:
    ...
    try:
        ...
        process_mysql_to_iceberg(spark, settings, db_manager, service, table_name, num_partition)
